...
`full_description`: Does the volume have a paragraph that describes the dataset fully? yes, no (some descriptive explanation) or NA (no descriptive explanation of data)
